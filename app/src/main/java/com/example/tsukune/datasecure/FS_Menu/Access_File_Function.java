...
public class Access_File_Function {
    ...
    public void Check_Decrypted_Directory_Exist(Context context) {
...
//    public void saveFile(Context context, String file) {
//        String fullpath = context.getFilesDir().getAbsolutePath() + "/EncryptedFile";
//        try{
